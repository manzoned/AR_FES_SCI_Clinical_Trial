...
public class RegTargetPalmPos : MonoBehaviour
{
...
/*
        ...
        {
            Vector3 regTarPos = new Vector3(TargetPalm.tempPosition.x, TargetPalm.tempPosition.y + 0.2f, TargetPalm.tempPosition.z);
